...
def run():
    # Render thường dùng cổng 10000 hoặc biến môi trường PORT
...
# --- Giữ nguyên code Bot Telegram của bạn ở phía dưới ---
import telebot
import random
import os
...
payos = PayOS(
    client_id=os.getenv('3bee4f70-74b8-4179-a7c2-8bcdb71f623c'),
    api_key=os.getenv('229cb1ec-0b41-421d-9747-7f858479028b'),
    checksum_key=os.getenv('cc90bf06dc170250328773423dc431cbd3452526f8cf477467164c5d98b1e30a')
)
